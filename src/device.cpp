...
Device::Device( Window &window ) : window{ window } {
  ...
  // connect to GPU/graphics device
  pickPhysicalDevice();

  // abstraction layer for features of the graphics device
  createLogicalDevice();

  // set up command pool for command buffers (which will be explained later)
  createCommandPool();
}
